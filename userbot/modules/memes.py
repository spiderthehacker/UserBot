...
CHU_STRINGS = [
     "`Taare hai Asmaan me very very bright jhaat na jala bsd dekh le apni height.`",
...
FUK_STRINGS = [
   ...
   "`Chachaa Ooo bhosdi wale Chacha`",
...
ABUSEHARD_STRING = [
	...
	"`Tum Ameer hum gareeb hum jhopdiwale Tum bhosdiwale`",
	"`Nikal Lawde,Pehli Fursat me nikal.`",
	"`Teri jaat ka paida maaru bsdk`",
	"`Ah! You're a ceritifed Madarhox`",
]
HELLOSTR = [
    "`Hi !`",
    "`‘Ello, gov'nor!`",
